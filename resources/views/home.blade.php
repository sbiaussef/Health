...
@section('content')
    ...
    <!--/ doctor team-->
    <section id="rendezvous" class="section-padding">
                <div class="jumbotron">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    
                        <h3>Prendre le Rendez-vous</h3>
                        <div class="panel-body">
                            ...
                            <form action="/addrv" method="post">
                                ...
                                <input  type="date" class="form-control br-radius-zero" name="dt" ><br>
                                <input  type="time" class="form-control br-radius-zero" name="tm" ><br>
                                <textarea name="remarque" class="form-control br-radius-zero" placeholder="TAPEZ VOTRE REMARQUE" rows="10"></textarea><br>
                                <input type="submit" class="btn btn-form" value="accept">
                            </form>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        © Copyright Mr SBIA Youssef. All Rights Reserved
                        <div class="credits">
